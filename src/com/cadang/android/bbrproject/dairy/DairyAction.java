...
public class DairyAction {
	...
	public DairyAction(Context context) {
		mContext = context;
	}
	...
	public MyDairy getNhatKyByID(long id) {
		MyDairy obj = null;
		open();
	...
	public ArrayList<MyDairy> getAllNhatKy() {
		ArrayList<MyDairy> glstNhatky = new ArrayList<MyDairy>();
		try {
			open();
			Cursor cursor = mDB.query(DATABASE_TABLE, new String[] { KEY_ID,
